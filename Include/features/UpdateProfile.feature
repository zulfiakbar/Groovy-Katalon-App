...
Feature: Update Profile
  ...
  Scenario: User want to update profile password
    ...
    And User input "Test1234" into Recent Password field
    And User input "12345678" into New Password field
    And User input "12345678" into Confirmation Password field
    And User click on Simpan button
    Then User verify profile updated
